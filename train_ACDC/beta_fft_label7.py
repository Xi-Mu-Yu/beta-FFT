...
def load_net_opt(net: nn.Module, optimizer: optim.Optimizer, path: str) -> None:
...
# ###########################
            ...
            mix_factors = torch.tensor(mix_factors, dtype=torch.float).cuda()
            ...
            mix_factors_s = torch.tensor(mix_factors_s, dtype=torch.float).cuda()
